...
export const PROFILE_EDIT_PATH = `${PROFILE_SETTING_PATH}/edit`;
...
export const PROFILE_EMAIL_EDIT_PATH = `${PROFILE_SETTING_PATH}/edit/email`;
export const PROFILE_BIRTHDATE_EDIT_PATH = `${PROFILE_SETTING_PATH}/edit/birthdate`;
export const PROFILE_GENDER_EDIT_PATH = `${PROFILE_SETTING_PATH}/edit/gender`;
export const PROFILE_PASSWORD_EDIT_PATH = `${PROFILE_SETTING_PATH}/edit/password`;
