...
export const SEARCH_POST_POPULAR_QUERY_PARAM = 'popular';

export const SEARCH_POST_LASTEST_FILTER_NAME = '최신';
export const SEARCH_POST_LASTEST_FILTER_ID = 2;
export const SEARCH_POST_LASTEST_QUERY_PARAM = 'live';
...
// 로그인 페이지
export const KAKAO_LOGIN_TITLE_NAME = '카카오로 시작하기';
export const NAVER_LOGIN_TITLE_NAME = '네이버로 시작하기';
export const GOOGLE_LOGIN_TITLE_NAME = '구글로 시작하기';
