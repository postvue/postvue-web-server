...
import MasonryLayout_ from './masonry/MasonryLayout';
...
const SnsPostMasonryLayout_: React.FC<SnsPostMasonryLayoutProps> = ({
  snsPostList,
  ...
  // @REFER: 현재 필요한 기능 인지 더 파악하고 필요하지 않으면 삭제
  // useEffect(() => {
    ...
    <>
      <MasonryLayout_
        ...
        fetchMoreOption={{
          ...
          customLoader: (
            <h1 style={{ textAlign: 'center' }}>Custom Loader...</h1>
          ), // optional prop
        }}
      >
...
export default SnsPostMasonryLayout_;
