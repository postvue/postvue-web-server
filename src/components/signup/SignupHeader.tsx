...
const SignupHeader: React.FC = () => {
  ...
  const signupStepList = [
    ...
    {
      stepNum: SIGNUP_BIRTHDATE_INPUT_STEP_VALUE,
      queryParam: SIGNUP_BIRTHDATE_INPUT_STEP_QUERY_PARAM_VALUE,
    },
    {
      stepNum: SIGNUP_GENDER_INPUT_STEP_VALUE,
      queryParam: SIGNUP_GENDER_INPUT_STEP_QUERY_PARAM_VALUE,
    },
    {
