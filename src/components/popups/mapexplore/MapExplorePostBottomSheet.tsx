...
interface MapExplorePostBottomSheetProps {
  ...
  hasGeoCurrentPositionButton?: boolean;
  hasGeoPositionRefreshButton?: boolean;
}

const MapExplorePostBottomSheet: React.FC<MapExplorePostBottomSheetProps> = ({
  ...
  popupBottomGap = 120,
  children,
  hasGeoCurrentPositionButton = true,
  hasGeoPositionRefreshButton = true,
}) => {
  popupTopHeight =
    popupTopHeight +
      parseFloat(
  ...
  const popupBottomHeight = height - popupTopHeight - popupBottomGap;
  ...
  return (
    <BottomSheetLayoutConatiner as={animated.div}>
      ...
      >
        ...
        <BottomSheetWrap
          ref={ScrollRef}
          $heightNum={height - popupTopHeight - headerHeight - bottomHeight}
          as={animated.div}
          {...sheetBind()}
          onTouchStart={(e) => {
...
export default MapExplorePostBottomSheet;
