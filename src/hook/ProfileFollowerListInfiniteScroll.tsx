...
import { PROFILE_LIST_PATH } from 'services/appApiPath';
import { getMyProfileFollowerList } from 'services/profile/getMyProfileFollowerList';
  ...
  const { fetchNextPage, hasNextPage, isFetchingNextPage, data } =
    useInfiniteQuery<PostProfileInfoRsp[], AxiosError>({
      ...
      queryFn: async ({ pageParam }) => {
        ...
        return getMyProfileFollowerList(username, pageParam);
      },
