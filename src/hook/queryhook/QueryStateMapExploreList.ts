...
import { getNearForMeList } from 'services/post/home/getNearForMeList';
...
> => {
  ...
  >({
    ...
    queryFn: async ({ pageParam }) => {
      ...
      return getNearForMeList(pageParam, latitude, longitude, nearFilter);
    },
    ...
    enabled: latitude > 0 && longitude > 0 && isActive,
  });
};
