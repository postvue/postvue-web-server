...
export interface ProfileFollowingListInfiniteInterface {
  pages: PostProfileInfoRsp[][];
  pageParams: unknown[];
}

export const QueryStateProfileFollowingListInfinite = (
  username: string,
): UseInfiniteQueryResult<
  ProfileFollowingListInfiniteInterface,
  AxiosError<unknown, any>
> => {
  return useInfiniteQuery<PostProfileInfoRsp[], AxiosError>({
